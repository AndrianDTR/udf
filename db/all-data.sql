...
-- Dumping data for table udf.championship_tours: ~1 rows (approximately)
...
-- Dumping data for table udf.championship_tour_pass: ~0 rows (approximately)
