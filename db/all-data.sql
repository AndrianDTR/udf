...
-- Dumping data for table udf.championship_team_categories: ~6 rows (approximately)
...
-- Dumping data for table udf.championship_team_dancers: ~7 rows (approximately)
