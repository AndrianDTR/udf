...
STR_DEFINITION(STR_FORMAT_START_NUMBER, "%04d");
STR_DEFINITION(STR_FORMAT_TOUR_NAME, "%s (%d)");

STR_DEFINITION(STR_FORMAT_CS_NAME, "%s (%ld)");
STR_DEFINITION(STR_FORMAT_BLOCK_NAME, "%s, %s");
...
STR_DEFINITION(STR_START_NUMBER, "Start number");
STR_DEFINITION(STR_TEAM, "Team");
STR_DEFINITION(STR_COMPOSITION, "Composition");
