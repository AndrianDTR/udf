...
std::string CLigaTable::GetTableName()
{
	return TABLE;
}

std::string CLigaTable::GetFilterString(const tDATA* const filter)
{
...
long CLigaTable::Find(tTableMap& data, const tDATA* const filter)
{
	long res = UDF_E_FAIL;
