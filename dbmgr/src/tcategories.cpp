...
std::string CCategoriesTable::GetTableName()
{
	return TABLE;
}

std::string CCategoriesTable::GetFilterString(const tDATA* const filter)
{
...
long CCategoriesTable::Find(tTableMap& data, const tDATA* const filter)
{
	long res = UDF_E_FAIL;
